		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','whether_there_are_seedlings')">是否有苗
					</th>
					<th class="diy_title" v-if="$check_field('get','work_shift')">上班时间
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','whether_there_are_seedlings')">
						<span>
							{{ o["whether_there_are_seedlings"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','work_shift')">
						<span>
							{{ o["work_shift"] }}
						</span>
					</td>
