				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/student_vaccination_appointment/edit','add')" @click="to_form('/student_vaccination_appointment/edit')" >学生预约 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/teacher_vaccination_appointment/edit','add')" @click="to_form('/teacher_vaccination_appointment/edit')" >教师预约 </button>
							</div>
						<!-- 富文本 -->
		...
		data() {
			return {
				...
				itemList: [
						...
						{
							title: "是否有苗",
							name: "whether_there_are_seedlings",
							type: "下拉"
						},
						{
							title: "上班时间",
