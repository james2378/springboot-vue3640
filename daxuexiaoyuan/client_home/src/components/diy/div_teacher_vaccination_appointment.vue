<template>
	<div class="diy_details_box diy_div_teacher_vaccination_appointment">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "teacher_vaccination_appointment",
					source_field: "teacher_vaccination_appointment_id",
					source_id: this.obj["teacher_vaccination_appointment_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/teacher_vaccination_appointment/set?teacher_vaccination_appointment_id=' + _this.obj["teacher_vaccination_appointment_id"], {
								praise_len
							}, (res) => {
								if(res.result){
