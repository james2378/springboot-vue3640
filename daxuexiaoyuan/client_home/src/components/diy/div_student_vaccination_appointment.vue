<template>
	<div class="diy_details_box diy_div_student_vaccination_appointment">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "student_vaccination_appointment",
					source_field: "student_vaccination_appointment_id",
					source_id: this.obj["student_vaccination_appointment_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/student_vaccination_appointment/set?student_vaccination_appointment_id=' + _this.obj["student_vaccination_appointment_id"], {
								praise_len
							}, (res) => {
								if(res.result){
