...
const routes = [
	...
	//学生接种预约添加路由
	{
		path: '/student_vaccination_appointment/edit',
		name: '/student_vaccination_appointment_edit',
		component: () => import('../views/student_vaccination_appointment/edit.vue')
	},
	//教师接种预约添加路由
	{
		path: '/teacher_vaccination_appointment/edit',
		name: '/teacher_vaccination_appointment_edit',
		component: () => import('../views/teacher_vaccination_appointment/edit.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "大学校园防疫与服务系统-home";
	document.title = title;
	document.logo = "大学校园防疫与服务系统"
})
