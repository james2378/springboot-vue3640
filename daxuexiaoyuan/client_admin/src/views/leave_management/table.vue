<template>
	<el-main class="bg">
			...
			<el-row>
				<el-col :xs="24" :sm="24" :lg="8">
					<el-form-item label="请假单号">
						<el-input v-model="query.leave_no"></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :lg="8">
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/leave_management/table','add') || $check_action('/leave_management/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/leave_management/table','del') || $check_action('/leave_management/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="leave_no" label="请假单号"
				v-if="user_group == '管理员' || $check_field('get','leave_no')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/leave_management/table','set') || $check_action('/leave_management/view','set') || $check_action('/leave_management/view','get') || $check_action('/销假/table','add') || $check_action('/销假/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/leave_management/table','set') || $check_action('/leave_management/view','set') || $check_action('/leave_management/view','get')"
						:to="'./view?' + field + '=' + scope.row[field]"
						 size="small">
						<span>编辑</span>
					</router-link>
					<!--跨表按钮-->
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/leave_application/view')" v-if="user_group == '管理员' || $check_action('/leave_application/table','add') || $check_action('/leave_application/view','add')">
						<span>销假</span>
					</el-button>
				</template>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/leave_management/get_list?like=0",
				url_del: "~/api/leave_management/del?",
